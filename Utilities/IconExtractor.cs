...
namespace TaskFolder.Utilities
{
    ...
    public static class IconExtractor
    {
        ...
        /// <summary>
        /// Returns the generic "globe/URL" icon from shell32.dll (index 13).
        /// Used as the default icon for .url shortcut files.
        /// </summary>
        public static Icon ExtractUrlIcon()
        {
